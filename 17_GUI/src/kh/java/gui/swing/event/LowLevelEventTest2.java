...
public class LowLevelEventTest2 extends JFrame {
	...
	public class MyKeyListener implements KeyListener{
		...
		@Override
		public void keyPressed(KeyEvent e) { //발생순서 : 1
			System.out.println(e.getKeyCode() + " " + e.getKeyChar()); //KeyChar 한짜씩 입력받으려구
...
//				System.out.println("엔터를 입력하셨습니다");
		...
		@Override
		public void keyReleased(KeyEvent e) { //발생순서 : 2

		}

		@Override
		public void keyTyped(KeyEvent e) {//발생순서 : 3
	...
	private void initTopPanel() {
		...
		panel.add(input); //TextField너비지정, 컬럼수로 너비지정 간으      
